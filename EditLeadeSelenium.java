...
public class EditLeadeSelenium {
	public static void main(String[] args)throws InterruptedException {
		...
		driver.findElement(By.xpath("(//div[@id='center-content-column']//input)[2]")).sendKeys("kannan");
		driver.findElement(By.xpath("//button[text()='Find Leads']")).click();
		driver.findElement(By.xpath("//a[text()='kannan']")).click();
		Thread.sleep(5000);
		...
		String comName="TESTLEAFS (189237)";
